To keep maintenance effort low for Osmic the repository contains only the base our "source" versions of icons. All the derivative versions can be generated by using a script.
